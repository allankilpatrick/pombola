...
from .views import (CountyPerformanceView, CountyPerformanceSenateSubmission,
    ...
    YouthEmploymentView, YouthEmploymentSenateSubmission,
    YouthEmploymentPetitionSubmission,
...
for experiment_slug in ('youth-employment-bill',):
    ...
    for name, view in (
        ('senate', YouthEmploymentSenateSubmission),
        ('petition', YouthEmploymentPetitionSubmission)):
